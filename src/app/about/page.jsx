        ...
        <section className="mb-32">
          ...
          <div className="flex flex-col md:flex-row gap-12 border-t border-black pt-8">
            ...
            <div className="md:w-2/3">
              ...
              >
                I’m a Full - Stack Developer who builds complete,
                production-ready web applications from backend systems and APIs
                to clean, intuitive user interfaces. I currently freelance
                through RUBION, my independent studio for building modern
                websites.
              </motion.p>
              <motion.div
                initial={{ opacity: 0 }}
            ...
            <div className="md:w-1/3">
              <div className="sticky top-32">
                ...
                <p className="text-gray-500 max-w-xs leading-relaxed">
                  A timeline of my professional career and key contributions to
                  the tech industry.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-1/3">
              <div className="sticky top-32">
                ...
                <p className="text-gray-500 max-w-xs leading-relaxed">
                  A curated list of technologies I use to build performant,
